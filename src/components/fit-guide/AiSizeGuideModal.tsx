...
> = {
  pt: {
    title: "Descubra o seu tamanho",
    selectionTag: "Recomendação Instantânea",
    selectionTitle: "Descubra seu tamanho ideal",
    selectionDescription:
      "Resposta rápida, precisa e pensada para um caimento mais seguro.",
    selectionCardTitle: "Descobrir meu tamanho",
    selectionCardDescription:
      "Informe suas medidas e receba uma recomendação limpa e objetiva.",
    back: "Voltar",
    fastTag: "Ajuste Rápido",
    fastTitle: "Informe seu perfil",
    fastDescription:
      "Altura, peso e estrutura física bastam para uma recomendação premium.",
    height: "Altura",
    weight: "Peso",
    bodyType: "Tipo físico",
    calculate: "Calcular tamanho",
    resultTag: "Análise concluída",
    recommendedTitle: "Tamanho recomendado",
    fitTitle: "Caimento padrão",
    tighter: "Mais justo",
    looser: "Mais solto",
    continueShopping: "Continuar comprando",
    redo: "Refazer análise",
    decrease: "Diminuir",
    increase: "Aumentar",
  },
  en: {
  ...
  es: {
    title: "Descubre tu talla",
    selectionTag: "Recomendación Instantánea",
    selectionTitle: "Descubre tu talla ideal",
    selectionDescription:
      "Una respuesta rápida, precisa y pensada para un ajuste más seguro.",
    selectionCardTitle: "Descubrir mi talla",
    selectionCardDescription:
      "Ingresa tus medidas y recibe una recomendación clara y objetiva.",
    back: "Volver",
    fastTag: "Ajuste Rápido",
    fastTitle: "Cuéntanos tu perfil",
    fastDescription:
      "Altura, peso y estructura física bastan para una recomendación premium.",
    height: "Altura",
    weight: "Peso",
    bodyType: "Tipo físico",
    calculate: "Calcular talla",
    resultTag: "Análisis completado",
    recommendedTitle: "Talla recomendada",
    fitTitle: "Caída estándar",
    tighter: "Más ajustada",
    looser: "Más holgada",
    continueShopping: "Seguir comprando",
    redo: "Rehacer análisis",
    decrease: "Disminuir",
    increase: "Aumentar",
  },
};
